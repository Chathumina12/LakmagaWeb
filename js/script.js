...
// --- UX Enhancements: Scroll Progress + Back-to-Top + Page Transitions ---

// 1. Inject Scroll Progress Bar if not present
...
// 3. Inject Page Transition Overlay
...
document.addEventListener('click', (e) => {
    ...
    // Skip hash links, external links, downloads, and javascript:void
    if (href.startsWith('#') || href.startsWith('javascript:') || href.startsWith('http') || href.startsWith('mailto:') || link.hasAttribute('download') || link.getAttribute('target') === '_blank') return;
    
    // It's an internal page link
    e.preventDefault();
...
// Scroll Event for Navbar, Active Links, Progress Bar & Back-to-Top
